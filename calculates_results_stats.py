...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # TODO: 5a. Counts the number of pet images of dogs whose breed was
        ...
        if results_dic[key][3] == 1:
            ...
            # counts the number of correct dog classifications
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1

        # TODO: 5b. Counts the number of pet images that are NOT dogs and were
        #           correctly classified.
        else:
    ...
    # Calculates the number of total images
    results_stats_dic['n_images'] = len(results_dic)

    # Calculates the number of not-a-dog images using the number of images
    # and the number of dog images
    results_stats_dic['n_notdogs_img'] = results_stats_dic['n_images'] - results_stats_dic['n_dogs_img'] 

    # TODO: 5c. Calculates the percentage of correctly matched images.
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100.0

    # TODO: 5d. Calculates the percentage of correctly classified dog images.
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img']) * 100.0

    # TODO: 5e. Calculates the percentage of correctly classified breeds of dogs.
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] / results_stats_dic['n_dogs_img']) * 100.0

    # Calculates the percentage of correct not-a-dog images.
    ...
    # TODO: 5f. Returns the results_stats_dic dictionary that was created in this function
